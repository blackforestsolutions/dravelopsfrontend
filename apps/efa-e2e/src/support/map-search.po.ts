...
export const getDepartureIconAsset = (travelProvider: string) => `assets/${travelProvider}/departure_icon.svg`;
export const getArrivalIcon = () => cy.get('.arrival-icon');
export const getArrivalIconPath = () => getArrivalIcon().invoke('attr', 'src');
export const getArrivalIconAsset = (travelProvider: string) => `assets/${travelProvider}/arrival_icon.svg`;
