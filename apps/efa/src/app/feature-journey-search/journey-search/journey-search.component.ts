...
export class JourneySearchComponent implements OnInit, OnDestroy {
  ...
  departureTravelPoints$: Observable<AutocompleteTravelPointFragment[]>;
  arrivalTravelPoints$: Observable<AutocompleteTravelPointFragment[]>;
  ...
  displayTravelPointName(travelPoint: AutocompleteTravelPointFragment): string {
